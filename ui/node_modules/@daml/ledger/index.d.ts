import { Choice, ChoiceFrom, ContractId, List, Party, Template, TemplateOrInterface, Text } from "@daml/types";
/**
 ...
 */
export declare type LedgerOptions = {
...
declare class Ledger {
     ...
     *
     */
    createAndExercise<T extends object, C, R, K>(choice: ChoiceFrom<Template<T, K>> & Choice<T, C, R, K>, payload: T, argument: C): Promise<[R, Event<object>[]]>;
    /**
     ...
     */
    exerciseByKey<T extends object, C, R, K>(choice: ChoiceFrom<Template<T, K>> & Choice<T, C, R, K>, key: K, argument: C): Promise<[R, Event<object>[]]>;
    /**
